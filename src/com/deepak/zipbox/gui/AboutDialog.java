...
public class AboutDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        infoTextArea.setText("A java based zip utility. \n\nJust drag and drop files for processing.\nDrop zip files for unzipping. \nDrop non-zip files for zipping.\nDrop multiple files for zipping.\n\nSupported formats: \n7z, Zip, Tar, Rar, Lzma, Iso, GZip, Cpio, BZIP2, Z, Arj, Lzh, Cab, Chm, Nsis, DEB, RPM, UDF, WIM\n\nSupported zipping format:\nZip only\n\nDeveloped By : deepak pk\nEmail : deepakpk009@yahoo.in\n\nThis Project is Licensed under LGPL\n");
